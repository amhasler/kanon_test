...
(function() {
  jQuery(function() {
    ...
    $('.flip_back').click(function() {
      return $(this).parents('.card').addClass('flipped');
    });
    $('.flip_front').click(function() {
      return $(this).parents('.card').removeClass('flipped');
    });
    $('#max-date-trigger').click(function() {
      return $('#max-date').html('<input id="artobject_maxyear" name="artobject[maxyear]" class="artobject_input" type="text"> <div class="checkbox"> <label> <input id="max_bce" name="max_bce" type="checkbox"> BCE </label> </div>');
    });
    $(".artobject_tags").each(function() {
      var el;
      el = $(this);
      return el.tokenInput("/tags/index.json", {
        crossDomain: false,
    ...
    return $(".favorite_box").bind('change', function() {
      if (this.checked) {
        return $.ajax({
          url: '/favorites/',
          type: 'POST',
