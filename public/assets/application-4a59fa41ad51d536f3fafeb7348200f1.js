...
(function() {
  jQuery(function() {
    ...
    $('#max-date-trigger').click(function() {
      return $('#max-date').html('<input id="artobject_maxyear" name="artobject[maxyear]" placeholder="Year" type="text"> <div class="checkbox"> <label> <input id="max_bce" name="max_bce" type="checkbox"> BCE </label> </div>');
    });
    return $(".artobject_tags").each(function() {
      var el;
      el = $(this);
      return el.tokenInput("/artobjects/tags.json", {
        crossDomain: false,
